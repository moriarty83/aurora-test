...
namespace AuroraFPSRuntime.WeaponModules.RecoilSystem
{
    ...
    public sealed class CameraRecoil
    {
        ...
        public CameraRecoil(float upForce, float sideForce, Vector2 shakeForce, float snappiness, float returnSpeed)
        {
        ...
        public CameraRecoil(float upForce, float[] sideForcePattern, bool loopSidePattern, Vector2 shakeForce, float snappinessUp, float snappinessBack)
        {
            this.upForce = upForce;
        ...
        public CameraRecoil(float upForce, Vector2 sideForceRange, Vector2 shakeForce, float snappinessUp, float snappinessBack)
        {
            this.upForce = upForce;
        ...
        public void MoveNext(ref int index, ref Vector3 vector)
        {
            ...
            if(additionShake)
                cameraShaker.RegisterShake(new BounceShake(shakeSettings));
        }
